...
---
autores: Brayan Aguilar Mori (20162215) Claudia Escobar Pimentel (20164942) Maria
  Emma Macedo (20161246)
fecha: 11/07/2019
titulo: 'CONFLICTOS SOCIO-AMBIENTALES EN LAS PROVINCIAS DEL PERÚ DEL 2011 AL 2016:
  UNA APROXIMACIÓN CUANTITATIVA SOBRE SUS CAUSAS'
---

## Estadística para el análisis político 2 - POL304  
 
____
## **CONFLICTOS SOCIO-AMBIENTALES EN LAS PROVINCIAS DEL PERÚ DEL 2011 AL 2016: UNA APROXIMACIÓN CUANTITATIVA SOBRE SUS CAUSAS **
____
...
I.  __Índice __
    ...
    * [5.Análisis factorial y estandarización](#AF y estandarización) 
    * [6.Análisis de regresión binomial](#regresion)

####**1.Carga de datos**
```{r}
#CARGA DE LOS DATOS SOBRE CONFLICTOS SOCIO-AMBIENTALES 
...
#CARGA DE DATOS DE LA VARIABLE DE MEDIO AMBIENTE
    #CARGA DE LOS DATOS SOBRE DENUNCIAS AMBIENTALES EN LAS MUNICIPALIDADES DEL 2011 AL 2016
...
#CARGA DE DATOS SOBRE LA VARIABLE DE DESARROLLO SOCIAL
    #CARGA DE DATOS SOBRE JUNTOS Y QALI WARMA
...
Prog_soc2016_2= read.csv(Linkps2016_2, stringsAsFactors = F)
    ...
    #CARGA DE DATOS SOBRE NUMERO TOTAL DE ESTUDIANTES Y HOGARES DE CADA PROVINCIA
...
hogares= read.csv(Linkhogar, stringsAsFactors = F)
    ...
    #CARGA DE DATOS SOBRE POBREZA MONETARIA
...
#CARGA DE DATOS SOBRE LA VARIABLE DE CONSULTA PREVIA
    #CARGA DE DATOS SOBRE LA CONSULTA PREVIA
...
#CARGA DE DATOS SOBRE LA VARIABLE DE PARTICIPACION POLITICA
    #CARGA DE DATOS SOBRE BLANCOS Y AUSENTISMO ELECTORAL
...
#CARGA DE DATOS SOBRE LA VARIABLE DE PRESENCIA ESTATAL
    #CARGA DE DATOS SOBRE PRESENCIA ESTATAL
...
data= read.csv(link, stringsAsFactors = F)
    ...
    #CARGA DE DATOS SOBRE LA POBLACION DE CADA PROVINCIA
...
#CARGA DE DATOS SOBRE LA VARIABLE DE INDICE DEMOGRAFICO
    #CARGA DE DATOS SOBRE TASA DE ANALFABETISMO
...
Alfa= read.csv(Link_alfa, stringsAsFactors = F)
    ...
    #CARGA DE DATOS SOBRE COMUNIDADES CAMPESINAS E INDIGENAS
...
Comu= read.csv(Link_Comu, stringsAsFactors = F)
    ...
    #CARGA DE DATOS SOBRE LA POBLACION URBANA Y RURAL
...
Urb_rur= read.csv(Link_ur, stringsAsFactors = F)
    ...
    #CARGA DE DATOS SOBRE TASA DE MORTALIDAD
...
```{r}
#LIMPIEZA DE DATA SOBRE CONFLICTOS SOCIO-AMBIENTALES
...
#LIMPIEZA DE DATA SOBRE LA VARIABLE MEDIOAMBIENTAL
...
#MERGE DE LA DATA SOBRE LA VARIABLE DE MEDIO AMBIENTE
...
#LIMPIEZA DE DATAS SOBRE LA VARIABLE DESARROLLO SOCIAL
...
#MERGE DE LAS DATAS DE JUNTIOS Y QW
...
#LIMPIEZA DE DATA SOBRE LA VARIABLE DE PRESENCIA DEL ESTADO
...
#LIMPIEZA DE DATA SOBRE LA VARIABLE DEL INDICE DEMOGRÁFICO
Alfa=Alfa[,c(2,6)]
...
```
```{r}
DATA_TRABAJO[!complete.cases(DATA_TRABAJO),]
```
```{r}
table(DATA_TRABAJO$SIONO)
```


####**5.Análisis factorial y estandarización**

#####*Analisis factorial de la variable de presencia estatal
```{r}
...
#####*Analisis factorial de la variable de indice demográfico
```{r}
...
#####*Analisis factorial de la variable de desarrollo social
```{r}
...
#####*Estandarización de las demás variables numéricas  
```{r}
...
#####*Merge de las datas con el analisis factorial, con las estandarizacion para formar la data final
```{r}
